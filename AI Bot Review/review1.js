...
run();
## Step 4: The CI Workflow - GitHub Actions (code-review.yml)
This YAML file defines the automation. It tells GitHub when to run your script and how to run it. Create the file .github/workflows/code-review.yml and add this code:
  ...
  review:
    ...
    steps:
      ...
      - name: Run AI Code Review
        run: node review.js
        env:
          # Pass the secrets to the script as environment variables
